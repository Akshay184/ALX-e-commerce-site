            ...
            <img class="logo" src="images/alx-logo.png">
                ...
                <div class="menu">
                    <ul>
                        <li>
                            <b>
                                <asp:LinkButton ID="lnkBooks2" runat="server" Class="line" OnCommand="Books">BOOKS</asp:LinkButton></b></li>
                        <li>
                            <b>
                                <asp:LinkButton ID="lnlClothes" runat="server" Class="line" OnCommand="Clothes">CLOTHING</asp:LinkButton></b></li>
                        <li>
                            <b>
                                <asp:LinkButton ID="lnkElectronics" runat="server" CssClass="line" OnCommand="Electronics">ELECTRONICS</asp:LinkButton></b></li>
                        <li>
                            <b>
                                <asp:LinkButton ID="lnkFurniture" runat="server" CssClass="line" OnCommand="Furniture">FURNITURE</asp:LinkButton></b></li>
                        <li>
                            <b>
                                <asp:LinkButton ID="lnkVehicles" runat="server" CssClass="line" OnCommand="Vehicles">VEHICLES</asp:LinkButton></b></li>
                        ...
                        <li>
                            <asp:HyperLink ID="hylAddToCart" runat="server" NavigateUrl="~/USER_PANEL/AddToCart.aspx"><i class="fa fa-shopping-cart"></i> </asp:HyperLink></li>
               ...
               <%-- <button class="dropbtn">Sort </button>
                ...
                <div class="dropdown-content">
                    <asp:DropDownList ID="ddlFilter" runat="server">
                        ...
                        <asp:ListItem Value="2" Text="Price:High-Low"></asp:ListItem>
                   --%>
                    ...
                    <ItemTemplate>
                        <div class="card">
                            <asp:LinkButton ID="lnkDescription" runat="server" OnCommand="Description" CommandArgument='<%# Eval("ProductId") %>'>
                                ...
                                <h1>
                                    <asp:Label ID="lblProducuNmae" runat="server" Text='<%# Eval("ProductName") %>'></asp:Label></h1>
                                <p>
                                    <asp:Label ID="lblPrice" runat="server" Text='<%# Eval("Price") %>'><i class="fas fa-rupee-sign"></i></asp:Label></p>
